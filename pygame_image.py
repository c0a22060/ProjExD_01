...
def main():
    ...
    kk_imgs = [kk_img, kk_img2, kk_img3, kk_img4, kk_img5, kk_img6, kk_img7, kk_img8, kk_img9, kk_img10, kk_img11, kk_img10, kk_img9, kk_img8, kk_img7, kk_img6, kk_img5, kk_img4, kk_img3, kk_img2]
    tmr = 0
    x = 0
    while True:
